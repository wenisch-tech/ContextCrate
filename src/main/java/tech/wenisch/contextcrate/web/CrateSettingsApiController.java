...
public class CrateSettingsApiController {
  ...
  @PutMapping("/rag") public RagSettings rag(@PathVariable UUID crateId,@RequestBody RagRequest r){
    ...
    return rag.update(crateId,r.strictGrounding(),r.allowClientHistory(),r.inlineCitations(),
        r.structuredSources(),r.gradingEnabled()==null?current.isGradingEnabled():r.gradingEnabled(),r.answerVerificationEnabled()==null?current.isAnswerVerificationEnabled():r.answerVerificationEnabled(),r.answerVerificationFailureAction()==null?current.getAnswerVerificationFailureAction():r.answerVerificationFailureAction(),r.retrievalMode(),r.sourceLimit());
  }
  ...
  public record RagRequest(boolean strictGrounding,boolean allowClientHistory,boolean inlineCitations,
      boolean structuredSources,Boolean gradingEnabled,Boolean answerVerificationEnabled,String answerVerificationFailureAction,String retrievalMode,int sourceLimit){}
