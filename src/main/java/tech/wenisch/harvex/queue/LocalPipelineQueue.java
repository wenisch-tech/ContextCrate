...
@Component
@ConditionalOnProperty(name = "harvex.queue.backend", havingValue = "local", matchIfMissing = true)
public class LocalPipelineQueue implements PipelineQueue {
  ...
  public LocalPipelineQueue(PipelineWorkItemRepository repository, HarvexProperties properties) {
