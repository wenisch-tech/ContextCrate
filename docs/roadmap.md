...
1. Add BM25 retrieval over the existing document/chunk fields with filters, highlighting, and evaluation fixtures.
2. Add embedding generation and versioned Lucene/OpenSearch vector mappings, followed by hybrid score fusion.
